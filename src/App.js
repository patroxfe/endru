...
function Gallery() {
	...
	return (
		<div className='content wrapper overflow-hidden' id='gallery'>
		...
		<div className='wrapper'>
			<div className='summary-section'>
				...
				<div className='summary-description summary'>
					<p>
						Specjalizujemy się w projektowaniu i produkcji niestandardowych mebli, dostosowanych do potrzeb klientów.
						Oferujemy wysoką jakość i kreatywne podejście.
					</p>
				</div>
			</div>
		</div>
				...
				<div className='footer-area'>
					...
					<div className='footer-contact'>
						<div className='contact'>
							...
							<a href='mailto:andrzej.kosnik85@wp.pl'>andrzej.kosnik85@wp.pl</a>
						</div>
						<div className='contact'>
							<div className='contact-title'>
								<svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' viewBox='0 0 24 24'>
						...
						<div className='contact'>
							...
							<a href='tel:+48503153424' className='clickable'>
								+48 503 153 424
							</a>
						</div>
					</div>
